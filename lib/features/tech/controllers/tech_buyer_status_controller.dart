...
/// Контроллер состояния доставки для техника-покупателя
/// Использует GetX для управления состоянием и навигации.
class TechBuyerStatusController extends GetxController {
  ...
  void startDeliveryProcess() {
    ...
    Future.delayed(interval * 6, () {
      currentStep.value = 6;
      // Переход на экран завершения доставки для техника-покупателя
      Future.delayed(const Duration(seconds: 1), () {
        final orderToPass = orderData.value;
        Get.offNamed('/tech-buyer-completed', arguments: orderToPass);
      });
    });
  }
